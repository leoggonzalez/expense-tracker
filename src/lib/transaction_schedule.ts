...
export type TransactionDateMode = "month" | "date";
export type TransactionScheduleMode = "one_time" | "installments" | "unlimited";

export function inferTransactionDateMode(value: string): TransactionDateMode {
...
export function toDate(value: string, mode: TransactionDateMode): Date | null {
...
export function toModeValue(value: string, mode: TransactionDateMode): string {
  if (!value) {
    return "";
  }
