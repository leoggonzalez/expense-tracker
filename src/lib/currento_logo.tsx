...
export const CURRENTO_BRAND_COLORS = {
  background: "#0C5A64",
  border: "#0C5A64",
  mark: "#00D47E",
  accent: "#DDF8EC",
  ...
  return (
    ...
    >
      <rect
        ...
        height="47"
        rx="13.5"
        fill={CURRENTO_BRAND_COLORS.background}
        stroke={CURRENTO_BRAND_COLORS.border}
      />
      <path
