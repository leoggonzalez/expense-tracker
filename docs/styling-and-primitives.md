...
- The only approved inline-style exception is internal CSS custom property plumbing inside shared primitives such as `Stack`, `Box`, `Grid`, `Card`, and shared loading primitives like `LoadingSkeleton`.
